...
(function () {
  ...
  var SCEN = {
    'corp.html': [
      { q: '법인별 달성률 어디가 낮아?',
        a: '8개 법인 중 법인H가 82.4%로 가장 낮고, 법인G 88.7%가 뒤를 잇습니다. 나머지 6개 법인은 90% 이상이며 법인A·B는 목표를 초과 달성했습니다.',
    ...
    'monitoring_live.html': [
      { q: '지금 라인 상태 어때?',
        a: '가동 중 라인 기준 처리량 91,240모, 가동률 83%입니다. 미확인 이상 신호 3건, 금일 누적 정지 7건이며 정지 대부분은 5호 라인 예방 점검입니다.',
        rows: [['처리량', '91,240', '—'], ['가동률', '83%', '점검 1라인 제외'], ['이상 신호', '3건', '미확인']],
        link: { href: 'alarms.html', label: '알람 이력 보기' } },
      { q: '방금 뜬 이상 신호 뭐야?',
        a: '21:04 냉각온도 #2 상한 근접(+6.4°C)입니다. 같은 구간에서 20:41 냉장센터 B 온도 상승 경고가 먼저 있었고, 두 건 모두 입고 도어 개폐와 연동된 패턴입니다. 담당 호출은 아직 안 나갔습니다.',
        link: { href: 'temperature.html', label: '온습도 현황 보기' } }
    ],
    'lots.html': [
      { q: 'L-0812는 어디서 왔어?',
        a: '순두부 350g 로트 L-0812의 이력입니다. 8/10 입고된 대두(M-0788, 국산)를 8/12 06:20 배합·살균해 당일 포장했고, 현재 중앙물류에 1,240모가 남아 있습니다.',
        rows: [['원료', '대두 M-0788', '8/10 입고'], ['생산', '8/12 06:20', '2호 라인'], ['현재고', '1,240모', '중앙물류']],
        link: { href: 'wh_stock.html', label: '창고별 재고 보기' } },
      { q: '이 로트에 문제 생기면 회수 범위는?',
        a: '출고처는 12곳, 출고량 3,860모입니다. 같은 원료(M-0788)를 쓴 형제 로트가 2개 더 있어, 원료 이슈라면 회수 대상은 총 3개 로트 9,140모로 넓어집니다. 출고처 목록은 바로 내려받을 수 있습니다.',
        link: { href: 'goods_out.html', label: '출고 내역 보기' } }
    ],
    'dashboard.html': [
      { q: '이번 달 매출 어때?',
