...
(function () {
  ...
  /* ---------- 응답 로그: 행 선택 → 상세 ---------- */
  const LOGS = [
    { meta: "09:14 · 이서연", tags: ['<span class="tag tag--lv">Lv.2 관계 DB</span>', '<span class="tag tag--high">confidence: high</span>'],
      json: `{\n  <span class="k">"query"</span>: <span class="s">"이번 달 두부 확정수량은?"</span>,\n  <span class="k">"sources"</span>: [<span class="s">"plans"</span>, <span class="s">"storage_stocks"</span>],\n  <span class="k">"answer"</span>: <span class="s">"이번 달 두부 확정수량은 2,352,092입니다."</span>,\n  <span class="k">"confidence"</span>: <span class="s">"high"</span>\n}`, fb: null },
    { meta: "09:08 · 맑은물에", tags: ['<span class="tag tag--high">confidence: high</span>'],
      json: `{\n  <span class="k">"query"</span>: <span class="s">"상암점 이번 주 발주 추이 정리해줘"</span>,\n  <span class="k">"sources"</span>: [<span class="s">"plans"</span>],\n  <span class="k">"answer"</span>: <span class="s">"이번 주 상암점 발주는 두부 중심으로 12% 증가했습니다."</span>,\n  <span class="k">"confidence"</span>: <span class="s">"high"</span>\n}`, fb: null },
    { meta: "08:52 · 최수아", tags: ['<span class="tag tag--lv">Lv.3 멀티 DB 조합</span>', '<span class="tag tag--medium">confidence: medium</span>', '<span class="tag" style="background:var(--g1);color:var(--g8)">피드백 있음</span>'],
      json: `{\n  <span class="k">"query"</span>: <span class="s">"국산 백태 낫또 재고\n            며칠 치 남았어?"</span>,\n  <span class="k">"sources"</span>: [<span class="s">"orders"</span>, <span class="s">"plans"</span>, <span class="s">"storage_stocks"</span>],\n  <span class="k">"answer"</span>: <span class="s">"재고 1,234, 일평균 17.1 기준\n             약 72일 치입니다."</span>,\n  <span class="k">"confidence"</span>: <span class="s">"medium"</span>\n}`,
    ...
    { meta: "08:41 · 맑은물에", tags: ['<span class="tag tag--high">confidence: high</span>'],
      json: `{\n  <span class="k">"query"</span>: <span class="s">"창고별 두부 재고 알려줘"</span>,\n  <span class="k">"sources"</span>: [<span class="s">"plans"</span>],\n  <span class="k">"answer"</span>: <span class="s">"지난주 상암점 안전재고은 4.2%입니다."</span>,\n  <span class="k">"confidence"</span>: <span class="s">"high"</span>\n}`, fb: null },
    { meta: "08:20 · 김민준", tags: ['<span class="tag tag--low">confidence: low</span>', '<span class="tag" style="background:var(--tint-red);color:var(--neg)">권한 없음</span>'],
